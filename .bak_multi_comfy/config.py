...
DEFAULTS_LINUX = {
    ...
    "comfyui_port": "8188",
    # 두 번째 ComfyUI 인스턴스(별도 물리 GPU 전용)의 포트. 같은 ComfyUI 폴더를
    # 쓰지만 --port / --user-directory로 1번 인스턴스와 격리됩니다.
    "comfyui_port_gpu1": "8189",
...
ENV_MAP = {
    ...
    "comfyui_port_gpu1": "COMFY_PORT_GPU1",
    ...
    "autostart_comfyui_gpu1": "AUTOSTART_COMFYUI_GPU1",
